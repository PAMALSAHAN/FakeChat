...
function ChatScreen({ route, navigation }) {
    ...
    const [isJoined, setIsJoined] = useState(false)  //chat ekata join wenawada nadda kiyala balaganna 

    const { item } = route.params //meken thama issella screen eke parameters tika ganne
